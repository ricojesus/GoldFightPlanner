    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Planejamento de Voo VFR</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
          <div class="box-body">
        ...
        <div class="box box-info">
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#aeronave">Aeronave</a></li>
          ...
          <div class="box-body">
            <div class="tab-content">
              <div id="aeronave" class="tab-pane fade in active">
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-6">
